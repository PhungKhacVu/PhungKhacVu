document.addEventListener('DOMContentLoaded', () => {
    ...
    const savePrompt = async (promptData) => {
        ...
        try {
            ...
            // ⚡ Bolt: Optimistic UI update instead of N+1 fetchPrompts()
            ...
            renderPromptList(searchInput.value); // Re-render local state
    ...
    const deletePrompt = async (id) => {
        ...
        try {
            ...
            // ⚡ Bolt: Optimistic UI update to prevent refetch

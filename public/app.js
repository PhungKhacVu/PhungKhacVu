document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderPromptForm = (prompt = {}) => {
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (!data.id) delete data.id; // Prevent empty string id from overwriting random id on server
            savePrompt(data);
        });
    ...
    importFileInput.addEventListener('change', (e) => {
        ...
        reader.onload = async (event) => {
            try {
                ...
                renderPromptList(searchInput.value); // Re-render once all local updates have finished
                renderWelcomeScreen();
            } catch (err) {

document.addEventListener('DOMContentLoaded', () => {
    ...
    const savePrompt = async (promptData, skipRender = false) => {
        ...
        try {
            ...
            // ⚡ Bolt Optimization: Local state update to avoid full refetch
            // Why: Prevents N+1 fetches during bulk imports
            // Impact: Significant reduction in HTTP requests during import
            // Measurement: Verify network tab for fewer GET requests
    ...
    const deletePrompt = async (id) => {
        ...
        try {
            ...
            // ⚡ Bolt Optimization: Local state update to avoid full refetch
            // Why: Prevents unnecessary HTTP request after deletion
            // Impact: Faster UI update after deletion
            // Measurement: Verify network tab for lack of GET request on delete

document.addEventListener('DOMContentLoaded', () => {
    ...
    // Why: Avoids full fetchPrompts() N+1 network requests
    // Impact: Faster responsiveness and massive improvement on bulk imports
    // Measurement: Check network dev tools - saving a prompt triggers only 1 request instead of 2.
